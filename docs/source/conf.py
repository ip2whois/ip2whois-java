...
myst_html_meta = {
    "description": "IP2WHOIS Java library user to easily implement the checking of WHOIS information for a particular domain into their solution using the API from https://www.ip2whois.com.",
    "keywords": "IP2WHOIS, whois, domain, Java",
...
html_title = "IP2WHOIS Java SDK"

# html_baseurl = "https://ip2whois-java.readthedocs.io/en/latest/"