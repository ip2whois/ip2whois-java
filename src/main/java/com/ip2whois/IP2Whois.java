 ...
 * <p>
 * Copyright (c) 2002-2024 IP2Whois.com
 * <p>
 *
 * @author IP2Whois.com
 * @version 1.0.0
...
public class IP2Whois {
    ...
    private static final String SOURCE = "sdk-java";
    private static final String FORMAT = "json";
    private static final String SOURCE_VERSION = "1.0.0";
    private static final String ERROR_WHOIS = "Whois lookup error.";
    ...
    /**
     * This function to store the API key.
     *
     * @param key The IP2WHOIS API key.
     */
    ...
    public JsonObject Lookup(String domain) throws Exception {
        String url = BASE_URL + "?format=" + FORMAT + "&source=" + SOURCE + "&source_version=" + SOURCE_VERSION + "&key=" + apiKey + "&domain=" + URLEncoder.encode(domain, StandardCharsets.UTF_8);
     ...
     */
    public static String toNormalText(String domain) {
     ...
     */
    public static String toDomainName(String url) {
     ...
     */
    public static String toDomainExtension(String str) {
